...
import com.example.alertify.databinding.ActivityHighAuthoritySeeAnalyticsBinding;
...
public class HighAuthoritySeeAnalyticsActivity extends AppCompatActivity {

    private ActivityHighAuthoritySeeAnalyticsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHighAuthoritySeeAnalyticsBinding.inflate(getLayoutInflater());
    ...
    private void getDataFromIntent() {
        Intent intent = HighAuthoritySeeAnalyticsActivity.this.getIntent();
        ...
        depAdminRef.child(depAdminId).child("complaintList").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    Toast.makeText(HighAuthoritySeeAnalyticsActivity.this, "Complaints not found", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(HighAuthoritySeeAnalyticsActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
