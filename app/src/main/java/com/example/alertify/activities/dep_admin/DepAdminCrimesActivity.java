...
import com.example.alertify.adapters.dep_admin.DepAdminCrimesAdp;
import com.example.alertify.databinding.ActivityDepAdminCrimesBinding;
...
public class DepAdminCrimesActivity extends AppCompatActivity {

    private ActivityDepAdminCrimesBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDepAdminCrimesBinding.inflate(getLayoutInflater());
    ...
    private void init() {
        ...
        binding.crimesRecycler.setLayoutManager(new LinearLayoutManager(DepAdminCrimesActivity.this));
    ...
    private void checkCrimeAlreadyExistOrNot(CrimesModel crimesModel) {
        crimesRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot crimesSnapshot : snapshot.getChildren()) {
                        ...
                        if (crime.getCrimeType().equalsIgnoreCase(crimesModel.getCrimeType())) {
                            ...
                            Toast.makeText(DepAdminCrimesActivity.this, "Crime type already exists. Please enter a different one", Toast.LENGTH_SHORT).show();
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(DepAdminCrimesActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        crimesRef.child(crimesModel.getCrimeType()).setValue(crimesModel).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(DepAdminCrimesActivity.this, "Crime added successfully", Toast.LENGTH_SHORT).show();
                    crimesDialogProgressbar.setVisibility(View.INVISIBLE);
                    crimesDialog.dismiss();
                }
            }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(DepAdminCrimesActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                crimesDialogProgressbar.setVisibility(View.INVISIBLE);
            }
        });
    }
    ...
    private void setDataToRecycler(List<CrimesModel> crimes) {
        DepAdminCrimesAdp adp = new DepAdminCrimesAdp(DepAdminCrimesActivity.this, crimes);
