...
import com.example.alertify.fragments.dep_admin.DepAdminAnalyticsFragment;
import com.example.alertify.fragments.dep_admin.DepAdminComplaintsFragment;
import com.example.alertify.fragments.dep_admin.DepAdminEmergencyRequestsFragment;
import com.example.alertify.fragments.dep_admin.DepAdminRecordsFragment;
...
public class DepAdminMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dep_admin_drawer_layout);
    ...
    private void init() {
        ...
        appSharedPreferences = new AppSharedPreferences(DepAdminMainActivity.this);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.complaints:
                        ...
                        return true;
                    case R.id.records:
                        loadFragment(new DepAdminRecordsFragment());
                        return true;
                    case R.id.emergency:
                        loadFragment(new DepAdminEmergencyRequestsFragment());
                        return true;
                    case R.id.analytics:
                        loadFragment(new DepAdminAnalyticsFragment());
                        return true;
                }
                return false;
            }
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.profile:
                        Intent profileIntent = new Intent(DepAdminMainActivity.this, DepAdminProfileActivity.class);
    ...
    private void keepSharedPreferencesUpToDate() {
        depAdminRef.child(depAdminId).addValueEventListener(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(DepAdminMainActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
