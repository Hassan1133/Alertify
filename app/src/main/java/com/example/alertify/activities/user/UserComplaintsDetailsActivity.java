...
import com.example.alertify.databinding.ActivityUserComplaintsDetailsBinding;
import com.example.alertify.databinding.ComplaintFeedbackDialogBinding;
...
public class UserComplaintsDetailsActivity extends AppCompatActivity implements View.OnClickListener {

    private ActivityUserComplaintsDetailsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityUserComplaintsDetailsBinding.inflate(getLayoutInflater());
    ...
    private void downloadEvidence() {
        ...
        if(evidenceUrl != null && !evidenceUrl.isEmpty() && evidenceType != null && !evidenceType.isEmpty())
        {
            ...
            if (downloadManager != null) {
                ...
                Toast.makeText(UserComplaintsDetailsActivity.this, "Download started", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(UserComplaintsDetailsActivity.this, "Download Manager not available", Toast.LENGTH_SHORT).show();
            }
        }
        else {
            Toast.makeText(UserComplaintsDetailsActivity.this, "Evidence not found", Toast.LENGTH_SHORT).show();
        }
    }

    private void createFeedBackDialog() {
        complaintFeedbackDialogBinding = ComplaintFeedbackDialogBinding.inflate(LayoutInflater.from(UserComplaintsDetailsActivity.this));
        feedBackDialog = new Dialog(UserComplaintsDetailsActivity.this);
    ...
    private void sendFeedback(String feedback) {
        ...
        complaintsRef.child(complaintModel.getComplaintId()).updateChildren(map).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(UserComplaintsDetailsActivity.this, "Feedback sent successfully", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(UserComplaintsDetailsActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
