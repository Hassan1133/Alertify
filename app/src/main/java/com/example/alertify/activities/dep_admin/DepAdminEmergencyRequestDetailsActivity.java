...
import com.example.alertify.databinding.ActivityDepAdminEmergencyRequestDetailsBinding;
...
public class DepAdminEmergencyRequestDetailsActivity extends AppCompatActivity {

    private ActivityDepAdminEmergencyRequestDetailsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDepAdminEmergencyRequestDetailsBinding.inflate(getLayoutInflater());
    ...
    private void init() {
        ...
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(DepAdminEmergencyRequestDetailsActivity.this);
        getDataFromIntent();
    ...
    private void getDataFromIntent() {
        ...
        loadingDialog = LoadingDialog.showLoadingDialog(DepAdminEmergencyRequestDetailsActivity.this);
    ...
    private void getUserData(String userId) {
        usersRef.child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(DepAdminEmergencyRequestDetailsActivity.this, "", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        emergencyRequestsRef.child(emergencyServiceModel.getRequestId()).updateChildren(map).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(DepAdminEmergencyRequestDetailsActivity.this, "seen", Toast.LENGTH_SHORT).show();
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(DepAdminEmergencyRequestDetailsActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void getLastLocation() {
        if (ActivityCompat.checkSelfPermission(DepAdminEmergencyRequestDetailsActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(DepAdminEmergencyRequestDetailsActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            return;
        }
            ...
            public void onSuccess(Location location) {
                ...
                if (location != null) {
                    ...
                    if (depAdminCurrentLatitude != 0 && depAdminCurrentLongitude != 0 && userLatitude != 0 && userLongitude != 0) {
                        ...
                        Toast.makeText(DepAdminEmergencyRequestDetailsActivity.this, "Please select your location again", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(DepAdminEmergencyRequestDetailsActivity.this, "Unable to retrieve location", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void openGoogleMapsForDirections(double startLat, double startLon, double destLat, double destLon) {
        ...
        if (mapIntent.resolveActivity(this.getPackageManager()) != null) {
            ...
            Toast.makeText(DepAdminEmergencyRequestDetailsActivity.this, "Google Maps not installed in this device", Toast.LENGTH_SHORT).show();
        }
    }
