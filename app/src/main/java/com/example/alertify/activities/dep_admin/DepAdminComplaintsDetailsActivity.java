...
import com.example.alertify.databinding.ActivityDepAdminComplaintsDetailsBinding;
...
public class DepAdminComplaintsDetailsActivity extends AppCompatActivity implements View.OnClickListener {

    private ActivityDepAdminComplaintsDetailsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDepAdminComplaintsDetailsBinding.inflate(getLayoutInflater());
    ...
    void getDataFromIntent() {
        ...
        loadingDialog = LoadingDialog.showLoadingDialog(DepAdminComplaintsDetailsActivity.this);
    ...
    private void getUserData(String userId) {
        usersRef.child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(DepAdminComplaintsDetailsActivity.this, "", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void updatedComplaintStatusToDb(String status) {
        ...
        complaintsRef.child(complaintModel.getComplaintId()).updateChildren(map).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Toast.makeText(DepAdminComplaintsDetailsActivity.this, "Investigation status updated successfully", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(DepAdminComplaintsDetailsActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void downloadEvidence() {
        ...
        if (evidenceUrl != null && !evidenceUrl.isEmpty() && evidenceType != null && !evidenceType.isEmpty()) {
            ...
            if (downloadManager != null) {
                ...
                Toast.makeText(DepAdminComplaintsDetailsActivity.this, "Download started", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(DepAdminComplaintsDetailsActivity.this, "Download Manager not available", Toast.LENGTH_SHORT).show();
            }
        } else {
            Toast.makeText(DepAdminComplaintsDetailsActivity.this, "Evidence not found", Toast.LENGTH_SHORT).show();
        }
    }
