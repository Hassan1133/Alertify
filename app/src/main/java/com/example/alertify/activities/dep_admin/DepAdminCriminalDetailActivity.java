...
import com.example.alertify.adapters.dep_admin.DepAdminCriminalCrimesAdp;
import com.example.alertify.databinding.ActivityDepAdminCriminalDetailBinding;
...
public class DepAdminCriminalDetailActivity extends AppCompatActivity implements View.OnClickListener {

    private ActivityDepAdminCriminalDetailBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDepAdminCriminalDetailBinding.inflate(getLayoutInflater());
    ...
    private void init() {
        ...
        binding.recyclerView.setLayoutManager(new LinearLayoutManager(DepAdminCriminalDetailActivity.this));
        fetchFIR();
    }
    ...
    private void fetchFIR() {
        criminalsRef.child(criminalsModel.getCriminalCnic()).child(FIR_REF).addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(DepAdminCriminalDetailActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void setDataToRecycler(List<CriminalCrimesModel> criminalCrimes) {
        DepAdminCriminalCrimesAdp adp = new DepAdminCriminalCrimesAdp(DepAdminCriminalDetailActivity.this, criminalCrimes);
    ...
    private void createFirDialog() {
        addFirDialog = new Dialog(DepAdminCriminalDetailActivity.this);
        ...
        criminalsRef.child(criminalsModel.getCriminalCnic()).child(FIR_REF).child(id).setValue(criminalCrimesModel).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(DepAdminCriminalDetailActivity.this, "Data Added", Toast.LENGTH_SHORT).show();
                    addFirDialog.dismiss();
                }
            }
            ...
            public void onFailure(@NonNull Exception e) {
                progressBar.setVisibility(View.GONE);
                Toast.makeText(DepAdminCriminalDetailActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
