...
import com.example.alertify.databinding.ActivityDepAdminProfileBinding;
...
public class DepAdminProfileActivity extends AppCompatActivity {

    private ActivityDepAdminProfileBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDepAdminProfileBinding.inflate(getLayoutInflater());
    ...
    private void init() {
        ...
        appSharedPreferences = new AppSharedPreferences(DepAdminProfileActivity.this);
    ...
    private void createPasswordDialog() {
        editPasswordDialog = new Dialog(DepAdminProfileActivity.this);
        ...
        FirebaseAuth.getInstance().signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(task -> {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(DepAdminProfileActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
        ...
        firebaseUser.updatePassword(newPassword)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(DepAdminProfileActivity.this, "Password Updated Successfully", Toast.LENGTH_SHORT).show();
                            passwordDialogProgressBar.setVisibility(View.INVISIBLE);
                            editPasswordDialog.dismiss();
                        }
                    }
