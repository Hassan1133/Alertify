...
import com.example.alertify.databinding.ActivityDepAdminLoginBinding;
...
public class DepAdminLoginActivity extends AppCompatActivity {
    ...
    private ActivityDepAdminLoginBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDepAdminLoginBinding.inflate(getLayoutInflater());
    ...
    private void init() {
        ...
        appSharedPreferences = new AppSharedPreferences(DepAdminLoginActivity.this);
        ...
        binding.loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isValid()) {
                    loadingDialog = LoadingDialog.showLoadingDialog(DepAdminLoginActivity.this);
        ...
        firebaseAuth.signInWithEmailAndPassword(emailText, passwordText).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onFailure(@NonNull Exception e) {
                if (e instanceof FirebaseAuthInvalidCredentialsException) {
                    ...
                    Toast.makeText(DepAdminLoginActivity.this, "The Password is wrong", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void emailExistsOrNotForSignIn(String emailText) {
        depAdminRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot depAdminSnapShot : snapshot.getChildren()) {
                        ...
                        if (depAdminModel.getDepAdminEmail().equals(emailText) && depAdminModel.getDepAdminStatus().equals("unblock")) {
                            ...
                            LoadingDialog.hideLoadingDialog(loadingDialog);
                            Toast.makeText(DepAdminLoginActivity.this, "Account doesn't exist", Toast.LENGTH_SHORT).show();
                        }
                    }
                } else {
                    LoadingDialog.hideLoadingDialog(loadingDialog);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(DepAdminLoginActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void getFCMToken() {
        FirebaseMessaging.getInstance().getToken().addOnCompleteListener(new OnCompleteListener<String>() {
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(DepAdminLoginActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void goToMainActivity() {
       appSharedPreferences.put("depAdminLogin", true);
        ...
        Intent intent = new Intent(DepAdminLoginActivity.this, DepAdminMainActivity.class);
    ...
    private void getProfileData() {
        if (depAdmin != null) {
            ...
            LoadingDialog.hideLoadingDialog(loadingDialog);
            Toast.makeText(DepAdminLoginActivity.this, "Logged in Successfully", Toast.LENGTH_SHORT).show();
            goToMainActivity();
        }
    }
}