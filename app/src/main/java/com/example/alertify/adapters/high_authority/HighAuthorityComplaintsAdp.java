...
import com.example.alertify.activities.high_authority.HighAuthorityComplaintsDetailsActivity;
...
public class HighAuthorityComplaintsAdp extends RecyclerView.Adapter<HighAuthorityComplaintsAdp.Holder> {

    private final Context context;

    private final List<ComplaintModel> complaintsList;

    public HighAuthorityComplaintsAdp(Context context, List<ComplaintModel> complaints) {
       ...
       if(complaintModel != null)
       {
           ...
           holder.detailBtn.setOnClickListener(new View.OnClickListener() {
               ...
               public void onClick(View v) {
                   Intent intent = new Intent(context, HighAuthorityComplaintsDetailsActivity.class);
