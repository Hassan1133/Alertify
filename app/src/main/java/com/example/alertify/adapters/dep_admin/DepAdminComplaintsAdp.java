...
import com.example.alertify.activities.dep_admin.DepAdminComplaintsDetailsActivity;
...
public class DepAdminComplaintsAdp extends RecyclerView.Adapter<DepAdminComplaintsAdp.Holder> {

    private final Context context;

    private final List<ComplaintModel> complaintsList;

    public DepAdminComplaintsAdp(Context context, List<ComplaintModel> complaints) {
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        ...
        holder.detailBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, DepAdminComplaintsDetailsActivity.class);
