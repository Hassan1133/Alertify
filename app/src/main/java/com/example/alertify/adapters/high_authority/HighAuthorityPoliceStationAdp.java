...
import com.example.alertify.activities.high_authority.HighAuthorityEditPoliceStationActivity;
...
public class HighAuthorityPoliceStationAdp extends RecyclerView.Adapter<HighAuthorityPoliceStationAdp.Holder> {
    ...
    public HighAuthorityPoliceStationAdp(Context context, List<PoliceStationModel> policeStations) {
        ...
        if(policeStation != null)
        {
            ...
            holder.editBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(context, HighAuthorityEditPoliceStationActivity.class);
    ...
    private void deletePoliceStationFromHighAuthorityList(String policeStationId) {
        ...
        String highAuthorityProfileId = appSharedPreferences.getString("highAuthorityId");
