...
import com.example.alertify.activities.high_authority.HighAuthorityPoliceStationBoundaryMapsActivity;
import com.example.alertify.adapters.high_authority.BoundaryAdapter;
import com.example.alertify.adapters.high_authority.HighAuthorityPoliceStationAdp;
import com.example.alertify.databinding.HighAuthorityPoliceStationBinding;
import com.example.alertify.databinding.PoliceStationDialogBinding;
...
public class HighAuthorityPoliceStationFragment extends Fragment implements View.OnClickListener {

    private HighAuthorityPoliceStationBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = HighAuthorityPoliceStationBinding.inflate(inflater, container, false);
        checkConnectivity();
    ...
    private void createDialog() {
        ...
        if (policeStationDialogBinding != null) {
            ...
            policeStationDialogBinding.dialogAddPoliceStationBoundaryBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(getActivity(), HighAuthorityPoliceStationBoundaryMapsActivity.class);
            ...
            policeStationDialogBinding.okBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (isValid()) {
                        ...
                        policeStation.setHighAuthorityId(appSharedPreferences.getString("highAuthorityId"));
    ...
    private void fetchData() {
        ...
        highAuthorityRef.child(appSharedPreferences.getString("highAuthorityId")).child("policeStationList").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
    ...
    private void setDataToRecycler(List<PoliceStationModel> policeStations) {
        HighAuthorityPoliceStationAdp adp = new HighAuthorityPoliceStationAdp(getActivity(), policeStations);
