...
import com.example.alertify.adapters.high_authority.HighAuthorityComplaintsAdp;
import com.example.alertify.databinding.HighAuthorityComplaintsBinding;
...
public class HighAuthorityComplaintsFragment extends Fragment {

    private HighAuthorityComplaintsBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = HighAuthorityComplaintsBinding.inflate(inflater, container, false);
    ...
    private void fetchComplaintsData() {
        ...
        highAuthorityRef.child(appSharedPreferences.getString("highAuthorityId")).child("complaintList").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void setDataToRecycler(List<ComplaintModel> complaints) {
        ...
        HighAuthorityComplaintsAdp complaintsAdapter = new HighAuthorityComplaintsAdp(getActivity(), complaints);
