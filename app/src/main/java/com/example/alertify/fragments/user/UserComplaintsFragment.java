...
import static com.example.alertify.constants.Constants.EVIDENCE_FILE_SIZE_LIMIT;
...
public class UserComplaintsFragment extends Fragment implements View.OnClickListener {

    private UserComplaintsFragmentBinding binding;
    ...
    private UserComplaintsAdapter complaintsAdapter;
